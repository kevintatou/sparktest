              ...
              <CardFooter className="flex justify-between border-t pt-4 bg-slate-50/50 dark:bg-slate-800/50">
                <div className="flex gap-2">
                  ...
                  <ConfirmationModal
                    ...
                    description={`Are you sure you want to delete "${definition.name}"? This action cannot be undone and will permanently remove the test definition and all its configuration.`}
                    onConfirm={() => handleDelete(definition.id)}
