...
export default function DefinitionsPage() {
  ...
  const handleRun = async (definitionId: string) => {
    ...
    try {
      const run = await storage.createRun(definitionId)
      toast({
        title: "🚀 Test run started!",
        description: `Run ${run.name || run.id.slice(0, 8)} is now executing.`,
      })
  ...
  return (
    <SidebarProvider defaultOpen={true}>
      ...
      <SidebarInset>
          ...
          <div className="flex h-14 items-center justify-between px-8 group-data-[collapsible=icon]:pl-20">
            <div className="flex items-center gap-4">
              <div className="relative flex-1 max-w-md">
                ...
                <input 
                  ...
                  className="pl-9 w-full px-3 py-2 bg-gray-100 dark:bg-gray-800 border-0 rounded-lg text-sm text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:ring-2 focus:ring-gray-900 dark:focus:ring-gray-300 focus:outline-none"
                  value={searchQuery}
            ...
            <div className="flex items-center gap-3">
              ...
              <Link 
                ...
                className="px-4 py-2 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm font-medium rounded-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors flex items-center gap-2"
              >
        ...
        <main className="min-h-screen bg-gray-50 dark:bg-gray-900 p-8 group-data-[collapsible=icon]:pl-20">
          <PageTransition>
            {/* Welcome section */}
            <div className="mb-8">
              <h1 className="text-2xl font-medium text-gray-900 dark:text-gray-100 mb-2">Test Definitions</h1>
              <p className="text-gray-600 dark:text-gray-400">Manage your test configurations and execution templates</p>
            </div>
            ...
            {filteredDefinitions.length === 0 ? (
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {filteredDefinitions.map((definition) => (
                  <div
                    key={definition.id}
                    className="bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 group"
                  >
                    {/* Card Header */}
                    <div className="p-6 pb-4">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400 truncate">{definition.image}</p>
                        </div>
                      </div>
                    ...
                    <div className="px-6 space-y-3">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <code className="text-xs bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-2 py-1 rounded max-w-32 truncate">
