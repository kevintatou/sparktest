              ...
              <CardFooter className="flex justify-between border-t pt-4 bg-slate-50/50 dark:bg-slate-800/50">
                <div className="flex gap-2">
                  ...
                  <ConfirmationModal
                    ...
                    description={`Are you sure you want to delete the test suite "${suite.name}"? This action cannot be undone and will permanently remove the suite and all its configuration. The individual test definitions will remain unchanged.`}
                    onConfirm={() => handleDelete(suite.id)}
