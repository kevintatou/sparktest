...
import { HybridStorageService } from "@sparktest/storage/hybrid-storage"
import { ApiStorageService } from "@sparktest/storage/api-storage"
import { LocalStorageService } from "@sparktest/storage/local-storage"

// Mock the storage services
vi.mock("@sparktest/storage/api-storage")
